...
if __name__ == "__main__":
    ...
    magnification_x = 4.0
    slit_size_in_um = 125.0 / 2.35 * nsigmas
    WF0 = run_multimode(up_to_mode=0)
    WF50 = run_multimode(up_to_mode=50)
    plot(WF0.get_abscissas(),WF0.get_intensity(),
         WF50.get_abscissas(),WF50.get_intensity())


    occupation0_over_occulation50 = 8.808346162314606431e-02 / 9.890906340106663253e-01

    print(WF0.get_intensity().sum() /  WF50.get_intensity().sum(), occupation0_over_occulation50)
