    ...
    if True:
        ...
        if True:
            fig2, ax2 = plot(
                ...
                numpy.array(F1), Hsrc,
                numpy.array(F1), Hslt,
                color=['b','cyan','darkred','r','r','b'],
                 marker=['o','o','o','o',None,None],
                 linestyle=['','','','','--','--'],
                 # yrange=[1,1e3], ylog=1,
                 yrange=[0,50], ylog=0,
                 legend=["$a_h$=%g" % (1e6*APERTURE_H[0]),"$a_h$=%g" % (1e6*APERTURE_H[1]),"$a_h$=%g" % (1e6*APERTURE_H[2]),"$a_h$=%g" % (1e6*APERTURE_H[3]),
                         "Analytical (source at Und)", "Analytical (source at Slit)"],
                 xtitle="$f_1$ [m]", ytitle="Horizontal FWHM [$\mu$m]", title="",
                 figsize=(16, 8),
                 show=0)
        ...
        if True:
            fig2, ax2 = plot(
                ...
                color=['b','cyan','darkred','r','r','b'],
                 ...
                 # yrange=[1,1e3], ylog=1,
                 yrange=[0,50], ylog=0,
                 legend=["$a_v$=%g" % (1e6*APERTURE_V[0]),"$a_v$=%g" % (1e6*APERTURE_V[1]),"$a_v$=%g" % (1e6*APERTURE_V[2]),"$a_v$=%g" % (1e6*APERTURE_V[3]),
                         "Analytical (source at Und)", "Analytical (source at Slit)"],
                 xtitle="$f_1$ [m]", ytitle="Vertical FWHM [$\mu$m]", title="",
                 figsize=(16,8),
                 show=0)
