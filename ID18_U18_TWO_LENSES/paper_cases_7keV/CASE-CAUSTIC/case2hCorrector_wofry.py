...
def run_beamline(output_wavefront, distance):
    ...
    optical_element = WOThinObjectCorrector1D(
        ...
        file_with_thickness_mesh='profile1DDD.dat',
        material='Be',
        focus_at=30,
        wall_thickness=5e-05,
    ...
    optical_element = WOThinObject1D(name='',file_with_thickness_mesh='profile1DDD.dat',material='Be')
    ...
    #
    propagation_elements = PropagationElements()
    beamline_element = BeamlineElement(optical_element=optical_element,    coordinates=ElementCoordinates(p=0.000000,    q=distance,    angle_radial=numpy.radians(0.000000),    angle_azimuthal=numpy.radians(0.000000)))
    propagation_elements.add_beamline_element(beamline_element)
    propagation_parameters = PropagationParameters(wavefront=input_wavefront,    propagation_elements = propagation_elements)
    #self.set_additional_parameters(propagation_parameters)
    #
