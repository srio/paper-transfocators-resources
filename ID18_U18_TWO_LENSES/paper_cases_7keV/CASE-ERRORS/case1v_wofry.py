...
def run_beamline(output_wavefront):    
    ...
    boundary_shape=Rectangle(-0.0001135, 0.0001135, -0.0001135, 0.0001135)
    ...
    #self.set_additional_parameters(propagation_parameters)
    #
    propagation_parameters.set_additional_parameters('magnification_x', shuffle(0.05))
    propagation_parameters.set_additional_parameters('magnification_N', 1.0)
    #
    propagator = PropagationManager.Instance()
    try:
...
def main():
    ...
    # tally.plot_cross_spectral_density(show=1,filename="case1v_wofry_cross_spectral_density.png")
    # tally.plot_spectral_density(show=1,filename="case1v_wofry_spectral_density.png")
    # tally.plot_occupation(show=1,filename="case1v_wofry_occupation.png")

        tally.save_spectral_density(filename="results/case1v_wofry_spectral_density_%03d.dat" % nrun)
        # tally.save_occupation(filename="case1v_wofry_occupation.dat")
