...
def main():
    ...
    for nrun in range(200):
        ...
        # tally.plot_cross_spectral_density(show=1,filename="case2h_wofry_cross_spectral_density.png")
        # tally.plot_spectral_density(show=1,filename="case2h_wofry_spectral_density.png")
        # tally.plot_occupation(show=1,filename="case2h_wofry_occupation.png")

        tally.save_spectral_density(filename="results2/case2h_wofry_spectral_density_%03d.dat" % nrun)
        # tally.save_occupation(filename="case2h_wofry_occupation.dat")
