...
def run_beamline(output_wavefront):    
    ...
    #
    propagation_parameters.set_additional_parameters('magnification_x', shuffle(5.0))
    ...
    #self.set_additional_parameters(propagation_parameters)
    #
    propagation_parameters.set_additional_parameters('magnification_x', shuffle(2.5))
    #
    propagator = PropagationManager.Instance()
    try:
    ...
    #self.set_additional_parameters(propagation_parameters)
    #
    propagation_parameters.set_additional_parameters('magnification_x', shuffle(0.025))
    propagation_parameters.set_additional_parameters('magnification_N', 1.0)
    #
    propagator = PropagationManager.Instance()
    try:
...
def main():
    ...
    for nrun in range(200):
        ...
        # tally.plot_cross_spectral_density(show=0,filename="case1h_wofry_cross_spectral_density.png")
        # tally.plot_spectral_density(show=0,filename="case1h_wofry_spectral_density.png")
        # tally.plot_occupation(show=0,filename="case1h_wofry_occupation.png")

        tally.save_spectral_density(filename="results/case1h_wofry_spectral_density_%03d.dat" % nrun)
        # tally.save_occupation(filename="case1h_wofry_occupation.dat")
