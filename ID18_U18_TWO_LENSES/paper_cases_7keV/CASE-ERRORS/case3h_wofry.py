...
def run_beamline(output_wavefront):    
    ...
    #self.set_additional_parameters(propagation_parameters)
    #
    propagation_parameters.set_additional_parameters('magnification_x', shuffle(0.1))
    propagation_parameters.set_additional_parameters('magnification_N', 1.0)
    #
    propagator = PropagationManager.Instance()
    try:
...
def main():
    ...
    for nrun in range(200):
        ...
        # tally.plot_cross_spectral_density(show=1,filename="case3h_wofry_cross_spectral_density.png")
        # tally.plot_spectral_density(show=1,filename="case3h_wofry_spectral_density.png")
        # tally.plot_occupation(show=1,filename="case3h_wofry_occupation.png")

        tally.save_spectral_density(filename="results3/case3h_wofry_spectral_density_%03d.dat" % nrun)
        # tally.save_occupation(filename="case3h_wofry_occupation.dat")
