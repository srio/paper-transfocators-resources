...
def main():
    ...
    tally.plot_cross_spectral_density(show=1,filename="case4v_wofry_cross_spectral_density.png")
    tally.plot_spectral_density(show=1,filename="case4v_wofry_spectral_density.png")
    tally.plot_occupation(show=1,filename="case4v_wofry_occupation.png")

    tally.save_spectral_density(filename="case4v_wofry_spectral_density.dat")
