...
def main():
    ...
    tally.plot_cross_spectral_density(show=0,filename="case7keV_8h_cross_spectral_density.png")
    tally.plot_spectral_density(show=0,filename="case7keV_8h_spectral_density.png")
    tally.plot_occupation(show=0,filename="case7keV_8h_occupation.png")

    tally.save_spectral_density(filename="case7keV_8h_spectral_density.dat")
    tally.save_occupation(filename="case7keV_8h_occupation.dat")
