...
#
#     tally.plot_cross_spectral_density(show=0, filename="case7keV_2h_cross_spectral_density.png")
#     tally.plot_spectral_density(show=0, filename="case7keV_2h_spectral_density.png")
#     tally.plot_occupation(show=0, filename="case7keV_2h_occupation.png")
#
#     tally.save_spectral_density(filename="case7keV_2h_spectral_density.dat")
#     tally.save_occupation(filename="case7keV_2h_occupation.dat")
#
#
# #
# # MAIN========================
...
if __name__ == "__main__":
    ...
    subdirectory = "./sizes_2h"

    a = numpy.loadtxt("trajectories_precalculated/f1_vs_f2_case2h.dat")
    F1 = a[:, 0].copy()
    F2 = a[:, 1].copy()
