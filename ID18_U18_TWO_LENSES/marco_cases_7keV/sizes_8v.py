...
if __name__ == "__main__":
    ...
    fileroot = "case7keV_8v"
    subdirectory = "./sizes_8v"

    a = numpy.loadtxt("trajectories_precalculated/f1_vs_f2_case8v.dat")
    F1 = a[:, 0].copy()  # numpy.array([45.61,71.48]) #
    F2 = a[:, 1].copy()  # numpy.array([9.28,7.92])   #
