...
def run_beamline(output_wavefront,radius1=10.0, radius2=10.0):
    ##########  OPTICAL SYSTEM ##########
    ...
    boundary_shape = Rectangle(-0.0001034, 0.0001034, -0.0001034, 0.0001034)
...
#
#     tally.plot_cross_spectral_density(show=0, filename="case7keV_2v_cross_spectral_density.png")
#     tally.plot_spectral_density(show=0, filename="case7keV_2v_spectral_density.png")
#     tally.plot_occupation(show=0, filename="case7keV_2v_occupation.png")
#
#     tally.save_spectral_density(filename="case7keV_2v_spectral_density.dat")
#     tally.save_occupation(filename="case7keV_2v_occupation.dat")
#
#
# #
# # MAIN========================
...
if __name__ == "__main__":
    ...
    fileroot = "case7keV_2v"
    subdirectory = "./sizes_2v"

    a = numpy.loadtxt("trajectories_precalculated/f1_vs_f2_case2v.dat")
    F1 = a[:, 0].copy()
    F2 = a[:, 1].copy()
    ...
    for i in range(len(R1)):
        ...
        for my_mode_index in range(50):
            output_wavefront = run_source(my_mode_index=my_mode_index)
            output_wavefront = run_beamline(output_wavefront, radius1=R1[i], radius2=R2[i])
            tally.append(output_wavefront)
