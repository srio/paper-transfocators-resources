...
for index in Index:
    ...
    print(">>>>>> ", a[0], a[1], a[3], a[4], "%s_spectral_density_%03d.dat" % (fileroot, index))
...
plot(numpy.array(Index), numpy.array(F2), xtitle="Index", ytitle="F2 [m]", title="trajectories F %s" %fileroot)
...
plot(numpy.array(Index), numpy.array(FWHM), xtitle="Index", ytitle="FWHM [um]", title="Sizes %s" %fileroot)
