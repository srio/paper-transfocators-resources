...
if __name__ == '__main__':
    ...
    file = 'intensity_bis7.0keV_intensity.dat'
    ...
    image = b4pt.Image2Plot(MI/amax(MI), x*1e6, y*1e6)
    image.legends = ['', '($\mu$m)', '($\mu$m)']
    image.LaTex = True
    image.AspectRatio = True
    image.ColorScheme = 2
    image.plt_limits = [-0.05, 1.05]
    image.ax_limits = [-100, 105 ,-105, 105]
    image.FontsSizeScale = 1.3
    image.sort_class()
    b4pt.plot_2D_cuts(image, 'intensity_MEconv_7keV.pdf', Enable=False, Silent=False)
    ...
    image = b4pt.Image2Plot(absolute(CSD)/amax(absolute(CSD)), x*1e6, y*1e6)
    image.legends = ['', '$x_1$ ($\mu$m)', '$x_2$ ($\mu$m)']
    image.LaTex = True
    image.AspectRatio = True
    image.ColorScheme = 7
    image.plt_limits = [-0.05, 1.05]
    image.ax_limits = [-105, 105 ,-105, 105 ]
    image.FontsSizeScale = 1.3
    image.sort_class()
    ...
    image = b4pt.Image2Plot(absolute(DoC)/amax(DoC), x*1e6, y*1e6)
    image.legends = ['', '$(x_1+x_2)/2$ ($\mu$m)', '$(x_1-x_2)/2$ ($\mu$m)']
    image.LaTex = True
    image.AspectRatio = True
    image.ColorScheme = 5
    image.plt_limits = [-0.05, 1.05]
    ...
    image = b4pt.Image2Plot(absolute(CSD)/amax(absolute(CSD)), x*1e6, y*1e6)
    image.legends = ['', '$y_1$ ($\mu$m)', '$y_2$ ($\mu$m)']
    image.LaTex = True
    image.AspectRatio = True
    image.ColorScheme = 7
    image.plt_limits = [-0.05, 1.05]
    ...
    image = b4pt.Image2Plot(absolute(DoC)/amax(absolute(DoC)), x*1e6, y*1e6)
    image.legends = ['', '$(y_1+y_2)/2$ ($\mu$m)', '$(y_1-y_2)/2$ ($\mu$m)']
    image.LaTex = True
    image.AspectRatio = True
    image.ColorScheme = 5
    image.plt_limits = [-0.05, 1.05]
    ...
    image = b4pt.Image2Plot(slc_Ih/amax(slc_Ih), axI_x*1e6)
    image.LaTex = True
    image.grid = True
    image.legends = ['', 'x ($\mu$m)', '(a.u.)']
    image.FontsSizeScale = 1.3
    image.ColorScheme = 1
    image.LineStyle = '-'
    ...
    image.LabelPos = 2
    image.grid = True
    image.ax_limits = [-105, 105, -0.05, 1.05]
    image.sort_class()
    b4pt.plot_1D(image, Enable=False, Hold=False)

    image = b4pt.Image2Plot(slc_DoCh, axDoC_x*1e6)
    image.LaTex = True
    image.grid = True
    image.legends = ['', 'x ($\mu$m)', '(a.u.)']
    image.FontsSizeScale = 1.3
    ...
    image = b4pt.Image2Plot(slc_Iv/amax(slc_Iv), axI_y*1e6)
    image.LaTex = True
    image.grid = True
    image.legends = ['', 'x ($\mu$m)', '(a.u.)']
    image.FontsSizeScale = 1.3
    ...
    image = b4pt.Image2Plot(slc_DoCv, axDoC_y*1e6)
    image.LaTex = True
    image.grid = True
    image.legends = ['', 'y ($\mu$m)', '(a.u.)']
    image.FontsSizeScale = 1.3
    image.ColorScheme = 2
    image.LineStyle = '-'
    image.label = 'DoC$_y$'
