...
if __name__ == '__main__':
    ...
    print('# transfocators paper: source parameters - intensity #') if (srwl_uti_proc_is_master()) else 0
    print('######################################################') if (srwl_uti_proc_is_master()) else 0
    ...
    strDataFolderName = 'source_imaging'
    prfx = 'intensity_bis'
    energy = str(beamE)
    ...
    pp_oe_0 = [0,0,1.0,1,0,1.0,15.0,1.0,18.11677282377919,0,0.0,0.0]

    srw_oe_array.append(oe_0)
    srw_pp_array.append(pp_oe_0)
    srw_pp_array.append([0,0,1,1,0,0.4,1,0.4,1,0,0.0,0.0])
    ...
    if srwl_uti_proc_is_master():
        ...
        if save is True or plots is True:
            ...
            srwl.CalcIntFromElecField(arI, wfr, 6, 1, 3, mesh.eStart, 0, 0)
        ...
        #     srwl.CalcIntFromElecField(arIx, wfr, 6, 1, 1, mesh.eStart, 0, 0)
