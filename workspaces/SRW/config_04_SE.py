...
if __name__ == '__main__':
    ...
    print('# transfocators paper: config 04 #') if (srwl_uti_proc_is_master()) else 0
    print('##################################') if (srwl_uti_proc_is_master()) else 0
    ...
    pp_drift_before_oe_5  = [0, 0, 1, 1, 0, 1., 1., 1.4142, 1., 0., 0., 0.]    # zero padding to reduce aliasing
    ...
    # ============= transfocator 2
    Rh = 20.7 * 2 * 6.960764234342776e-06
    ...
    Rv = 55.7* 2 * 6.960764234342776e-06
    ...
    # # # ============= reshape and resize
    pp_final = [0, 0, 1, 1, 0, 3/4, 1., 1., 1./2, 0., 0., 0.]
