...
if __name__ == "__main__":
    ...
    APERTURE = [227.0e-6, 506.7e-6, 1500e-6, -227.0e-6, -506.7e-6, -1500e-6]
    APERTURE = [25e-6, -25e-6]
    DISTANCE = numpy.linspace(10, 50, 50)  # numpy.array([10]) # numpy.array([30]) # 31.19 28.4
    ...
    for aperture in APERTURE:
        ...
        filename = "aperture_v_%g.dat" % (1e6 * aperture) #<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
        f = open(filename, 'w')
