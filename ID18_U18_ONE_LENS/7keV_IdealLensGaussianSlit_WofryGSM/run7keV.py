...
def run_wofry(source=None, aperture=1.0, distance=18.4168, number_of_points=2000):
    ...
    if source is None:
        ...
        output_wavefront.set_gaussian_hermite_mode(sigma_x=2.10675e-06, amplitude=1, mode_x=0, shift=0, beta=64.477)
    else:
        print(">>>>>>>>>>>>>>>>> RE-USING")
    ...
    optical_element = WOIdealLens1D(name='IdealLensF=14.3507', focal_length=14.3507)
