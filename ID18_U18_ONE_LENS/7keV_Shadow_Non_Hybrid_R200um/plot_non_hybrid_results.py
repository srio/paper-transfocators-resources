...
for i in range(len(FACTOR)):
    ...
    filein = "%s/non_hb_rt_aperture_factor_%g.h5" % (subdirectory, FACTOR[i])
    print(">>>>> ", filein)
...
# ile_png = "non_hybrid_ray-tracing_FWHM_dist_from_lens.pdf"
# lt.savefig(file_png)
# rint("File written to disk: %s" % file_png)
